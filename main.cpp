...
Point1 p1(1.0f * v, 0.5f * h);
Point1 p2(1.0f * v, 0.0f * h);
Point1 p3(1.0f * v, 1.0f * h);
Point1 p4(0.5f * v, 0.25f * h);
Point1 p5(1.5f * v, 0.25f * h);
Point1 p6(0.5f * v, 0.75f * h);
Point1 p7(1.5f * v, 0.75f * h);
